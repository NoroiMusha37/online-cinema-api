"""add movie-related models

Revision ID: 9135c849d5b3
Revises: 7d85064df8dd
Create Date: 2025-12-18 17:51:51.010741
...
revision: str = '9135c849d5b3'
down_revision: Union[str, Sequence[str], None] = '7d85064df8dd'
...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'year', 'time', name='uq_together_name_year_time')
    )
